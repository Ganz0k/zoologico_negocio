...
public class CtrlGuias {
     ...
     * referencia de una entidad itinerario a la lista guias que coincida con los
     * ids dados por el parámetro.
     *
     * @param itinerario itinerario a agregar a la lista de itinerarios del guia.
